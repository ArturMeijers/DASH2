...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = (window.DASH_SUPABASE_URL) || 'https://nrulvlxbxewaoqxxgzxo.supabase.co';
  const TOPBAR_SUPABASE_KEY = (window.DASH_SUPABASE_KEY) || 'sb_publishable_30005n3dZXir-FiyhvLh0Q_ePX53nXS';
